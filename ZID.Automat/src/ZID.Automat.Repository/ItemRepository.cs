...
namespace ZID.Automat.Repository
{
    public class ItemRepository : IItemRepository
    {
        ...
        public IReadOnlyList<Item> getPrevBorrowedItemsOfUser(int UserId) =>_context.Borrows.Include(b => b.ItemInstance).Where(b => b.UserId == UserId).Select(s => s.Item).Distinct().ToList();
        ...
        public int? loadItemFromQrCode(string QrCode) => _context.Borrows.Include(b=>b.ItemInstance).Include(b => b.Item).Where(b => b.UUID == QrCode).SingleOrDefault()?.ItemId;
    }
